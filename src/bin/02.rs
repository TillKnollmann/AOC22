...
fn get_score_pt_1(A: &str, B: &str) -> u32 {
    match A {
        "A" => match B {
            ...
            "Z" => 3 + 0, // rock vs. scissors means loose
            _ => {println!("Action unclear: {}", B); return 0;},
        },
        "B" => match B {
            "X" => 1 + 0, // paper vs. rock means loose
        ...
        "C" => match B {
            ...
            "Y" => 2 + 0, // scissors vs. paper means loose
